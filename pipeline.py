...
def get_config():
    ...
    parser.add_argument('--clear_graph_data', action='store_true', default=True)
    parser.add_argument('--clear_nn', action='store_true', default=True)
    parser.add_argument('--device', type=str, default='cuda:0')
    parser.add_argument('--model_name', type=str, default='ginesuperwide')
    ...
    parser.add_argument('--intermediate_save', action='store_true', default=False)
