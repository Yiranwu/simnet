...
def get_config_from_args():
    ...
    parser.add_argument('--dataset_name', type=str, default='t01')
...
def main():
    ...
    box2d_simulate(sid, eid, nmod, raw_dataset_name)
    '''
    dataset_name = generate_dataset(sid, eid, nmod, raw_dataset_name, name_only=config.no_datagen)
    ...
    '''
    dataset_name='1-1x100'
    config.exp_name='gine_noev_ep40_lr0.001000_h128_1-1x100'
